...
# P2/P3: verify reversible_compile(f, T; mul=:auto|:shift_add|:karatsuba|:qcla_tree)
...
@testset "mul dispatcher: :karatsuba forces Karatsuba" begin
    # Karatsuba kicks in only for W > 4; Int8 won't hit it. Test at Int16.
    c = reversible_compile((x, y) -> x * y, Int16, Int16; mul=:karatsuba)
    @test verify_reversibility(c)
    for x in (Int16(2), Int16(-3), Int16(100), Int16(0)), y in (Int16(3), Int16(-5), Int16(0))
        @test simulate(c, (x, y)) == (x * y)
    end
end
